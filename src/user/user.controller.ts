...
export class UserController {
  ...
  createUserHateoasLinks(userId: string | null, currentUserRole: Role): HateoasLink[] {
  ...
  @HasRoles(Role.USER)
  @Get('users/auth')
  async findOne(@GetCurrentUserId() userId: string, @getCurrentRole() role: Role) {
  ...
  @HasRoles(Role.ADMIN)
  @Patch('users/:id')
  async updateAdmin(@Body() updateUserDto: UpdateUserDto, @Param('id') id: string, @getCurrentRole() role: Role) {
  ...
  @HasRoles(Role.USER)
  @Delete('users')
  async remove(@GetCurrentUserId() userId: string, @getCurrentRole() role: Role) {
